 ...
 * that local date\"; backdated purchases/transfers follow the same rule so a
 * same-day record sorts after an earlier-timed checkpoint — the conservative
 * direction per SPEC §7.1). DST-safe: Europe/London transitions happen at
